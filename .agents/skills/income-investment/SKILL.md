...
description: "AI Berkshire skill: Income Investment: Durable and Opportunistic Distribution Analysis."
---
...
3. Apply `.agents/skills/financial-data/SKILL.md`: verify decision-critical financial data with at least two independent sources when available and flag discrepancies above 1%.
