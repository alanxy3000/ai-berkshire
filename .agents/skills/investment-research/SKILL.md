...
description: "AI Berkshire skill: 投资研究：巴菲特-芒格-段永平-李录 四大师综合分析框架."
---
...
> **数据源规范**：参见 `.agents/skills/financial-data/SKILL.md`。所有财务数据必须来自两个独立来源，误差>1%须标记。
...
**Step 2 — 取数核验：**
对清单中每个数据点，按 `.agents/skills/financial-data/SKILL.md` 规范从可靠信源取数
