...
description: Writing and layout overlay for AI Berkshire investment research reports. Use whenever Antigravity CLI creates, rewrites, revises, or critiques company/industry/fund research reports, especially long-form Markdown reports that need financial rigor, readable business mechanics, contrarian analysis, valuation-to-action guidance, investor-specific recommendations, restrained typography, and clear buy/hold/sell signals.
---
